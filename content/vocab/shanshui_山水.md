...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <span class="toc-topic">山水</span>
    <span class="toc-topic-en">Mountains and Water</span>
    ...
    <ul class="toc-list">
      <li><a href="#etymology">
        ...
        <span class="toc-sub">zìyuán · the dyad</span>
      </a></li>
      <li><a href="#confucian">
        <span class="toc-cn">智者乐水</span> The Confucian Couplet
        <span class="toc-sub">zhì zhě lè shuǐ · the wise love water</span>
      </a></li>
      <li><a href="#daoist">
        <span class="toc-cn">道家山水</span> The Daoist Landscape
        <span class="toc-sub">dàojiā shānshuǐ · landscape as Way</span>
      </a></li>
      <li><a href="#painting">
        <span class="toc-cn">山水画</span> Landscape Painting
        <span class="toc-sub">shānshuǐhuà · the genre</span>
      </a></li>
      <li><a href="#modern">
        <span class="toc-cn">现代用法</span> Modern Usage
        <span class="toc-sub">xiàndài yòngfǎ · today</span>
      </a></li>
      <li><a href="#chengyu">
  ...
  <main class="main">
    ...
    <div class="section-head">
      ...
      <span class="sh-en">Etymology — The Dyad</span>
    ...
    <div class="section-head">
      <span class="sh-cn">智者乐水</span>
      <span class="sh-py">zhì zhě lè shuǐ</span>
      <span class="sh-en">The Confucian Couplet — The Wise Love Water, the Benevolent Love Mountains</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card c-red">
        <div class="card-head">
          <span class="card-cn">智者乐水，仁者乐山</span>
          <span class="card-py">zhì zhě lè shuǐ, rén zhě lè shān</span>
          <span class="card-en">the wise take joy in water; the benevolent take joy in mountains</span>
        </div>
      ...
      <div class="card c-ochre">
        <div class="card-head">
          <span class="card-cn">乐山乐水</span>
          <span class="card-py">yào shān yào shuǐ</span>
          <span class="card-en">to take joy in mountains and water; to be a person of refined nature</span>
        </div>
    ...
    <div class="section-head">
      <span class="sh-cn">道家山水</span>
      <span class="sh-py">dàojiā shānshuǐ</span>
      <span class="sh-en">The Daoist Landscape — Going Into the Mountains</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <!-- ── PAINTING ── -->
    <span class="section-anchor" id="painting"></span>
    <div class="section-head">
      <span class="sh-cn">山水画</span>
      <span class="sh-py">shānshuǐhuà</span>
      <span class="sh-en">Landscape Painting — The Genre</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card c-teal">
        <div class="card-head">
          <span class="card-cn">山水风光</span>
          <span class="card-py">shānshuǐ fēngguāng</span>
          <span class="card-en">landscape scenery; mountain-and-water vistas</span>
        </div>
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">桂林的山水风光闻名世界。</div>
            <div class="ex-py">Guìlín de shānshuǐ fēngguāng wénmíng shìjiè.</div>
            <div class="ex-en">Guilin's landscape is famous throughout the world.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-violet">
        <div class="card-head">
          <span class="card-cn">山水之间</span>
          <span class="card-py">shānshuǐ zhī jiān</span>
          <span class="card-en">amid mountains and waters; in the landscape</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 短语</span></div>
        <div class="card-def">
          A literary phrase widely used in modern essays, song lyrics, and travel writing. 之间 zhī jiān = between; amid. The phrase carries the Daoist resonance of being <em>in</em> the landscape rather than looking <em>at</em> it. Common in tea-house names, hotel names, and book titles aimed at evoking refinement.
        </div>
        <div class="examples">
          <div class="example">
            <div class="ex-cn">他向往隐居山水之间的生活。</div>
            <div class="ex-py">Tā xiàngwǎng yǐnjū shānshuǐ zhī jiān de shēnghuó.</div>
            <div class="ex-en">He longs for the life of a hermit, dwelling amid mountains and waters.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-sienna">
        <div class="card-head">
          <span class="card-cn">山水诗</span>
          <span class="card-py">shānshuǐshī</span>
          <span class="card-en">landscape poetry; the mountain-and-water poem genre</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词</span></div>
        <div class="card-def">
          山水 + 诗 (shī, poem). The poetic genre that parallels the painting genre. Founded in the Six Dynasties period by Xie Lingyun (谢灵运, 385–433) and brought to its high point in the Tang by Wang Wei (王维) and Meng Haoran (孟浩然). Its commitments mirror those of 山水画: not description of a place but inhabitation of the dyad. Wang Wei's couplet 行到水穷处，坐看云起时 ("walk to where the water ends; sit and watch the clouds rise") is a textbook example.
        </div>
      </div>
    ...
    <div class="chengyu-grid">
      ...
      <div class="cy">
        <span class="cy-cn">仁者乐山，智者乐水</span>
        <span class="cy-py">rén zhě yào shān, zhì zhě yào shuǐ</span>
        <span class="cy-en">"the benevolent love mountains, the wise love water"</span>
        <span class="cy-note">The companion form of the Analects couplet, often quoted with the order reversed. 仁 (benevolence) and 智 (wisdom) are matched to mountain (immobile, supporting) and water (mobile, responsive) respectively. The full phrase is so embedded in the cultural vocabulary that it appears in tea-shop names, calligraphic scrolls, and corporate logos. Both halves are needed; the moral life requires both stillness and motion.</span>
      </div>
    ...
    <div class="adj-wrap">
      <span class="adj" data-relation="derived"><span class="a-cn">山水画</span><span class="a-py">shānshuǐhuà</span><span class="a-en">landscape painting</span></span>
      <span class="adj" data-relation="derived"><span class="a-cn">山水诗</span><span class="a-py">shānshuǐshī</span><span class="a-en">landscape poetry</span></span>
      <span class="adj" data-relation="synonym" data-distinct="江山 names the realm — mountains-and-rivers as the political body of the country; 山水 names the landscape as cosmological dyad and aesthetic subject"><span class="a-cn">江山</span><span class="a-py">jiāngshān</span><span class="a-en">rivers and mountains; the realm</span></span>
      <span class="adj" data-relation="contrast" data-distinct="风景 is the modern term for scenery — viewable, photographable, exterior; 山水 carries cosmological and ethical weight that 风景 does not"><span class="a-cn">风景</span><span class="a-py">fēngjǐng</span><span class="a-en">scenery; landscape (modern)</span></span>
      <span class="adj" data-relation="derived"><span class="a-cn">山</span><span class="a-py">shān</span><span class="a-en">mountain (the still half)</span></span>
      <span class="adj" data-relation="derived"><span class="a-cn">水</span><span class="a-py">shuǐ</span><span class="a-en">water (the flowing half)</span></span>
      <span class="adj" data-relation="collocation" data-distinct="智 in 山水 maps to water — adaptive, flowing wisdom; the Analects couplet is the source of this association"><span class="a-cn">智</span><span class="a-py">zhì</span><span class="a-en">wisdom (paired with water)</span></span>
      <span class="adj" data-relation="collocation" data-distinct="仁 in 山水 maps to mountain — supporting, enduring benevolence; the other half of the Analects couplet"><span class="a-cn">仁</span><span class="a-py">rén</span><span class="a-en">benevolence (paired with mountain)</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">无为</span><span class="a-py">wúwéi</span><span class="a-en">non-action; effortless action</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">隐居</span><span class="a-py">yǐnjū</span><span class="a-en">to live as a hermit</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">桂林</span><span class="a-py">Guìlín</span><span class="a-en">Guilin (canonical 山水 site)</span></span>
      <span class="adj" data-relation="collocation"><span class="a-cn">山清水秀</span><span class="a-py">shān qīng shuǐ xiù</span><span class="a-en">beautiful landscape</span></span>
    </div>
    ...
    <footer class="page-footer">
      <span class="footer-id">Jiǎoluò Shūwū · 角落書屋 · <span>山水 shānshuǐ</span> · shanshui_山水.html</span>
