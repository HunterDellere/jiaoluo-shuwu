...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <span class="toc-topic">方向</span>
    <span class="toc-topic-en">Direction &amp; Orientation</span>
    ...
    <ul class="toc-list">
      <li><a href="#etymology">
        ...
        <span class="toc-sub">zìyuán · 方 + 向 dissected</span>
      </a></li>
      <li><a href="#cardinal">
        <span class="toc-cn">四方八方</span> The Cardinal System
        <span class="toc-sub">sì fāng bā fāng · four and eight directions</span>
      </a></li>
      <li><a href="#literal">
        <span class="toc-cn">方位</span> Literal: Heading &amp; Position
        <span class="toc-sub">fāngwèi · physical orientation</span>
      </a></li>
      <li><a href="#figurative">
        <span class="toc-cn">人生方向</span> Figurative: Life Direction
        <span class="toc-sub">rénshēng fāngxiàng · the metaphor</span>
      </a></li>
      <li><a href="#chengyu">
  ...
  <main class="main">
    ...
    <!-- ── CARDINAL SYSTEM ── -->
    <span class="section-anchor" id="cardinal"></span>
    <div class="section-head">
      <span class="sh-cn">四方八方</span>
      <span class="sh-py">sì fāng bā fāng</span>
      <span class="sh-en">The Cardinal System — Four Sides, Eight Sides</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <!-- ── LITERAL HEADING ── -->
    <span class="section-anchor" id="literal"></span>
    <div class="section-head">
      <span class="sh-cn">方位</span>
      <span class="sh-py">fāngwèi</span>
      <span class="sh-en">Literal: Heading &amp; Physical Orientation</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card c-teal">
        <div class="card-head">
          <span class="card-cn">方向</span>
          <span class="card-py">fāngxiàng</span>
          <span class="card-en">direction; heading</span>
        </div>
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">他朝公园的方向走去。</div>
            <div class="ex-py">Tā cháo gōngyuán de fāngxiàng zǒu qù.</div>
            <div class="ex-en">He walked toward the direction of the park.</div>
          </div>
          <div class="example">
            <div class="ex-cn">我搞错了方向。</div>
            <div class="ex-py">Wǒ gǎo cuò le fāngxiàng.</div>
            <div class="ex-en">I got the direction wrong.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-teal">
        <div class="card-head">
          <span class="card-cn">方向感</span>
          <span class="card-py">fāngxiàng gǎn</span>
          <span class="card-en">sense of direction</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">我的方向感很差。</div>
            <div class="ex-py">Wǒ de fāngxiàng gǎn hěn chà.</div>
            <div class="ex-en">My sense of direction is terrible.</div>
          </div>
          <div class="example">
            <div class="ex-cn">这个团队需要明确的方向感。</div>
            <div class="ex-py">Zhège tuánduì xūyào míngquè de fāngxiàng gǎn.</div>
            <div class="ex-en">This team needs a clear sense of direction.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-teal">
        <div class="card-head">
          <span class="card-cn">方位</span>
          <span class="card-py">fāngwèi</span>
          <span class="card-en">cardinal position; bearing; orientation</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">请告诉我酒店的方位。</div>
            <div class="ex-py">Qǐng gàosù wǒ jiǔdiàn de fāngwèi.</div>
            <div class="ex-en">Please tell me the position of the hotel.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-teal">
        <div class="card-head">
          <span class="card-cn">方向盘</span>
          <span class="card-py">fāngxiàng pán</span>
          <span class="card-en">steering wheel</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">他握紧方向盘。</div>
            <div class="ex-py">Tā wò jǐn fāngxiàng pán.</div>
            <div class="ex-en">He gripped the steering wheel tightly.</div>
          </div>
        </div>
      </div>
    ...
    <!-- ── FIGURATIVE ── -->
    <span class="section-anchor" id="figurative"></span>
    <div class="section-head">
      <span class="sh-cn">人生方向</span>
      <span class="sh-py">rénshēng fāngxiàng</span>
      <span class="sh-en">Figurative: Life-Direction, Career-Direction, Political Direction</span>
      <span class="sh-rule"></span>
    </div>
    ...
    <div class="cards">
      ...
      <div class="card c-violet">
        <div class="card-head">
          <span class="card-cn">研究方向</span>
          <span class="card-py">yánjiū fāngxiàng</span>
          <span class="card-en">research direction; field of specialization</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">他的研究方向是宋代经济史。</div>
            <div class="ex-py">Tā de yánjiū fāngxiàng shì Sòng dài jīngjì shǐ.</div>
            <div class="ex-en">His research direction is Song-dynasty economic history.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-violet">
        <div class="card-head">
          <span class="card-cn">发展方向</span>
          <span class="card-py">fāzhǎn fāngxiàng</span>
          <span class="card-en">direction of development</span>
        </div>
        <div class="tags"><span class="tag tag-n">N 名词</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">绿色经济是未来的发展方向。</div>
            <div class="ex-py">Lǜsè jīngjì shì wèilái de fāzhǎn fāngxiàng.</div>
            <div class="ex-en">The green economy is the direction of future development.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-violet">
        <div class="card-head">
          <span class="card-cn">迷失方向</span>
          <span class="card-py">míshī fāngxiàng</span>
          <span class="card-en">to lose one's bearings; to be lost (literally or figuratively)</span>
        </div>
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">他在大城市里迷失了方向。</div>
            <div class="ex-py">Tā zài dà chéngshì lǐ míshī le fāngxiàng.</div>
            <div class="ex-en">He lost his way in the big city.</div>
          </div>
        </div>
      </div>
      ...
      <div class="card c-violet">
        <div class="card-head">
          <span class="card-cn">指明方向</span>
          <span class="card-py">zhǐmíng fāngxiàng</span>
          <span class="card-en">to point out the direction; to provide guidance</span>
        </div>
        <div class="tags"><span class="tag tag-v">V 动词短语</span></div>
        <div class="card-def">
        ...
        <div class="examples">
          <div class="example">
            <div class="ex-cn">老师为我们指明了方向。</div>
            <div class="ex-py">Lǎoshī wèi wǒmen zhǐmíng le fāngxiàng.</div>
            <div class="ex-en">The teacher pointed out our direction.</div>
          </div>
        </div>
      </div>

    </div><!-- /cards figurative -->
    ...
    <div class="adj-wrap">
      ...
      ><span class="a-cn">方向感</span><span class="a-py">fāngxiàng gǎn</span><span class="a-en">sense of direction</span></span>
      <span class="adj"
            data-relation="derived"
      ><span class="a-cn">方位</span><span class="a-py">fāngwèi</span><span class="a-en">cardinal position; bearing</span></span>
      <span class="adj"
            data-relation="derived"
            data-distinct="地方 is the noun for place — the same 方 in its region/locality sense"
      ><span class="a-cn">地方</span><span class="a-py">dìfāng</span><span class="a-en">place; locality</span></span>
      <span class="adj"
            data-relation="synonym"
            data-distinct="趋向 is more abstract — a tendency or trend; 方向 is the actual heading"
      ><span class="a-cn">趋向</span><span class="a-py">qūxiàng</span><span class="a-en">tendency; trend</span></span>
      <span class="adj"
            data-relation="collocation"
      ><span class="a-cn">东南西北</span><span class="a-py">dōng nán xī běi</span><span class="a-en">east, south, west, north</span></span>
      <span class="adj"
            data-relation="collocation"
      ><span class="a-cn">四面八方</span><span class="a-py">sì miàn bā fāng</span><span class="a-en">from all directions</span></span>
      <span class="adj"
            data-relation="collocation"
      ><span class="a-cn">前</span><span class="a-py">qián</span><span class="a-en">front; before</span></span>
      <span class="adj"
            data-relation="collocation"
      ><span class="a-cn">后</span><span class="a-py">hòu</span><span class="a-en">back; behind</span></span>
      <span class="adj"
            data-relation="collocation"
      ><span class="a-cn">左</span><span class="a-py">zuǒ</span><span class="a-en">left</span></span>
      <span class="adj"
            data-relation="collocation"
      ><span class="a-cn">右</span><span class="a-py">yòu</span><span class="a-en">right</span></span>
      <span class="adj"
            data-relation="contrast"
            data-distinct="目标 is the destination/goal; 方向 is the heading toward it"
      ><span class="a-cn">目标</span><span class="a-py">mùbiāo</span><span class="a-en">goal; target</span></span>
    </div>

    <footer class="page-footer">
      <span class="footer-id">Jiǎoluò Shūwū · 角落書屋 · <span>方向 fāngxiàng</span> · fangxiang_方向.html</span>
